...
%Hack to have footnote in the table caption.
\footnotetext{The shown values only consider sent data. To determine the total traffic (\ie data sent and data received) one should simply double those numbers.} 
