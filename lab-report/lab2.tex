...
\end{groupplot}
    ...
    % legend
    \begin{scope}[shift={(1,-1)}, mark size = 3] 
    \draw[ultra thick, yshift=3\baselineskip, draw=red]            (0,4) -- (0.5,4) ;
    \draw[ultra thick, yshift=3\baselineskip, draw=red!50!black]   (0.5,4) -- (1,4) node[right]{\texttt{g:}200};

    \draw[ultra thick, yshift=2\baselineskip, draw=blue]           (0,4) -- (0.5,4) ;
    \draw[ultra thick, yshift=2\baselineskip, draw=blue!50!white]  (0.5,4) -- (1,4) node[right]{\texttt{g:}400};
    
    \draw[ultra thick, yshift=1\baselineskip, draw=green]          (0,4) -- (0.5,4) ;
    \draw[ultra thick, yshift=1\baselineskip, draw=green!70!black] (0.5,4) -- (1,4) node[right]{\texttt{g:}800};
    
    \draw[ultra thick, draw=orange]                                (0,4) -- (0.5,4) ;
    \draw[ultra thick, draw=orange!50!black]                       (0.5,4) -- (1,4) node[right]{\texttt{g:}2000};

    \draw[yshift=1\baselineskip] (0,-0.5) -- plot[mark=triangle*, mark options={fill=white}]        (0.25,-0.5) -- (0.5,-0.5) node[right]{\texttt{pt:}422};
    \draw                        (0,-0.5) -- plot[mark=square*, mark options={fill=white}]          (0.25,-0.5) -- (0.5,-0.5) node[right]{\texttt{pt:}441};
    \end{scope}
